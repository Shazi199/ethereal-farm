...
var cnItems = {
    ...
    '→ Production boost for unspent resin': '→ 未用树脂提高的产量',
    'berry boost': '浆果提升',
    ...
    'boosts the bonus effect of ethereal neighbors of type berry, mushroom and flower by 50%. No effect if no appropriate neighbors. This crop boosts neighboring plants in the ethereal field, rather than boosting the basic field directly.': '使浆果，蘑菇和鲜花类型的灵巧相邻的奖励效果提高50％。 如果没有适当的邻居，则没有效果。 这种作物可以促进空灵领域的邻近植物，而不是直接促进基础领域。',
    ...
    'Boosting spores: 400%. Nerfing neighbor berries and flowers': '提升孢子:400%。削弱相邻的浆果和鲜花',
    ...
    'WARNING! if your mushrooms don\'t have enough seeds from neighbors, this upgrade will not help you for now since it also increases the consumption! Get your seeds production up first!': '警告！ 如果您的蘑菇没有来自相邻的足够的种子，那么此升级暂时不会为您提供帮助，因为它还会增加食用量！ 首先提高您的种子产量！',
    ...
    ': to duplicate full production of long-lived berry and mushroom neighbors for free (mushroom copy also consumes more': '：免费复制长寿命的浆果和蘑菇相邻的完整产量（蘑菇副本也会消耗更多',
    'Thousand': '数千',
    ...
    'Boosting spores: 5.1e3%. Nerfing neighbor berries and flowers': '促进孢子:5.1 e3%。削弱相邻的浆果和鲜花',
    ...
    'Boosting spores: 38.2e3%. Nerfing neighbor berries and flowers': '提升孢子:38.2 e3%。削弱相邻的浆果和鲜花',
    ...
    'boosts the bonus effect of ethereal neighbors of type berry, mushroom, flower and nettle. No effect if no appropriate neighbors. This crop boosts neighboring plants in the ethereal field, rather than boosting the basic field directly.': '提升浆果，蘑菇，花和荨麻等类型的空灵相邻的奖励效果。如果没有合适的邻居，就没有效果。这种作物可以提升以太田中的邻近植物，而不是直接提升基础田。',
    ...
    'Boosting spores: 5.52e3%. Nerfing neighbor berries and flowers': '促进孢子:5.52 e3%。削弱相邻的浆果和鲜花',
